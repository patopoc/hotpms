            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-calendar fa-fw"></i> Availability<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html"><i class="fa fa-angle-double-right  fa-fw"></i>Short Term</a>
                                </li>
                                <li>
                                    <a href="flot.html"><i class="fa fa-angle-double-right  fa-fw"></i>Long Term</a>
                                </li>                                
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
